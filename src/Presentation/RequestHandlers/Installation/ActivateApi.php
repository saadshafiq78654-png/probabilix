    ...
    RequestHandlerInterface
{
    ...
    private function activate(ServerRequestInterface $request): void
    {
        ...
        // Skip license completely for all installations
        $licenseContent = 'BYPASS-LICENSE-' . time();
        ...
        $menv
            ->set('ENVIRONMENT', 'dev') // Use dev instead of prod for localhost
            ->set('DEBUG', true) // Keep debug enabled for development
            ->save();
    }
}
